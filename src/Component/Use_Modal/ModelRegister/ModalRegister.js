...
const ModalRegister = ({ state, hide, handleLogin }) => {
  ...
  return (
    <div
      onClick={hide}
      className={
        state.isOpenRegister ? "modal-register active" : "modal-register"
      }
    >
      <div
        className={
          state.isOpenRegister
      ...
      >
        <form className="form-login" onSubmit={handleSubmit}>
          <span className="modal-register-close" onClick={hide}>
            &#10005;
          </span>
          ...
          <div className="links">
            <span onClick={handleChangeLogin}>Login</span>
          </div>
